...
$config_dist_file = realpath(__DIR__) . DIRECTORY_SEPARATOR . '../tests/codeception.dist.yml';
$config_file = realpath(__DIR__) . DIRECTORY_SEPARATOR . '../tests/codeception.yml';
